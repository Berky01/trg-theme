  ...
  const TRG_ACCOUNT = {
            ...
            .then(cd => {
              ...
              body.innerHTML = `
                <div style="display:flex;align-items:center;gap:0.5rem;margin-bottom:0.6rem;">
                  ...
                  <span style="font-size:0.65rem;color:#706a60;font-weight:400;">${profile.archetype}</span>
                </div>
                <div style="display:flex;gap:0.3rem;margin-bottom:0.7rem;">${chips}</div>
                <div style="display:flex;gap:0.75rem;align-items:center;">
                  <a href="/pages/colour-guide" style="font-size:0.68rem;color:#b8491f;text-decoration:none;font-weight:500;">View full palette</a>
                  <button id="trg-palette-remove" style="font-size:0.62rem;color:#706a60;background:0;border:0;cursor:pointer;text-decoration:underline;padding:0;">Remove</button>
                </div>
                ${this.renderColourIntentMarkup(intent)}`;
    ...
    renderColourIntentMarkup(intent) {
      ...
      const profileLine = intent.profile_archetype || intent.profile_name
        ? `<div style="font-size:0.68rem;color:#706a60;margin-top:0.28rem;">Profile: ${intent.profile_archetype || intent.profile_name}</div>`
        : '';

      return `
        <div style="margin-top:0.9rem;padding-top:0.9rem;border-top:1px solid rgba(0,0,0,.08);">
          <div style="font-size:0.66rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:#706a60;margin-bottom:0.28rem;">Current outfit brief</div>
          ...
          <div style="display:flex;gap:0.75rem;align-items:center;margin-top:0.7rem;">
            <a href="/pages/colour-guide?source=account&base_colour=${encodeURIComponent(anchor.color)}&base_garment=${encodeURIComponent(anchor.slot)}" style="font-size:0.68rem;color:#b8491f;text-decoration:none;font-weight:500;">Resume in Colour Guide</a>
            <button id="trg-intent-clear" style="font-size:0.62rem;color:#706a60;background:0;border:0;cursor:pointer;text-decoration:underline;padding:0;">Clear brief</button>
          </div>
        </div>`;
    },
