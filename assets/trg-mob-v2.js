...
var AB=
[
{n:"A Day's March",s:"a-days-march",c:"shirts-tops",p:"m"},
{n:"A Kind of Guise",s:"a-kind-of-guise",c:"shirts-tops",p:"m"},
{n:"A.P.C.",s:"a-p-c",c:"shirts-tops",p:"h"},
{n:"A.PRESSE",s:"a-presse",c:"shirts-tops",p:"m"},
{n:"Abaga",s:"abagavelli",c:"shirts-tops",p:"l"},
{n:"Ace Marks",s:"ace-marks",c:"footwear",p:"m"},
{n:"Acne Studios",s:"acne-studios",c:"shirts-tops",p:"h"},
{n:"Agolde",s:"agolde",c:"shirts-tops",p:"m"},
...
{n:"Ambrosi Napoli",s:"ambrosi-napoli",c:"tailoring",p:"l"},
{n:"American Giant",s:"american-giant",c:"shirts-tops",p:"h"},
{n:"American Trench",s:"american-trench",c:"accessories",p:"h"},
{n:"AMI Paris",s:"ami-paris",c:"shirts-tops",p:"h"},
{n:"Amiri",s:"amiri",c:"tailoring",p:"l"},
{n:"Anderson and Sheppard",s:"anderson-and-sheppard",c:"tailoring",p:"l"},
{n:"Anglo-Italian",s:"anglo-italian",c:"tailoring",p:"h"},
{n:"Another Aspect",s:"another-aspect",c:"shirts-tops",p:"m"},
...
{n:"Arpenteur",s:"arpenteur",c:"shirts-tops",p:"h"},
{n:"Ascotchang",s:"ascot-chang",c:"tailoring",p:"l"},
{n:"Asics",s:"asics",c:"footwear",p:"m"},
{n:"Asket",s:"asket",c:"shirts-tops",p:"h"},
{n:"Aspesi",s:"aspesi",c:"shirts-tops",p:"m"},
...
{n:"AvVattev",s:"avvattev",c:"tailoring",p:"l"},
{n:"AYR",s:"ayr",c:"shirts-tops",p:"m"},
{n:"Banana Republic",s:"banana-republic",c:"tailoring",p:"l"},
{n:"Baracuta",s:"baracuta",c:"outerwear",p:"m"},
{n:"Barbanera",s:"barbanera",c:"shirts-tops",p:"m"},
...
{n:"Bather",s:"bather",c:"shirts-tops",p:"m"},
{n:"Batoner",s:"batoner",c:"shirts-tops",p:"m"},
...
{n:"Bellief",s:"bellief",c:"tailoring",p:"m"},
...
{n:"Bode",s:"bode",c:"shirts-tops",p:"m"},
{n:"Bode",s:"bode",c:"tailoring",p:"l"},
{n:"Boglioli",s:"boglioli",c:"tailoring",p:"m"},
{n:"Bonobos",s:"bonobos",c:"shirts-tops",p:"m"},
...
{n:"Brass Tokyo",s:"brass-tokyo",c:"shirts-tops",p:"l"},
{n:"Bridlen",s:"bridlen",c:"footwear",p:"m"},
{n:"Brioni",s:"brioni",c:"tailoring",p:"h"},
{n:"Bronson Mfg. Co.",s:"bronson-mfg-co",c:"denim",p:"m"},
{n:"Brooks Brothers",s:"brooks-brothers",c:"tailoring",p:"h"},
{n:"Brunello Cucinelli",s:"brunello-cucinelli",c:"shirts-tops",p:"m"},
{n:"Brut",s:"brut",c:"shirts-tops",p:"m"},
...
{n:"032C",s:"032c",c:"shirts-tops",p:"l"},
...
{n:"Casatlantic",s:"casatlantic",c:"shirts-tops",p:"m"},
{n:"Casey Casey",s:"casey-casey",c:"shirts-tops",p:"l"},
{n:"Cavour",s:"cavour",c:"tailoring",p:"l"},
{n:"CDLP",s:"cdlp",c:"shirts-tops",p:"h"},
{n:"Cesare Attolini",s:"cesare-attolini",c:"tailoring",p:"h"},
{n:"Chapal",s:"chapal",c:"outerwear",p:"m"},
{n:"Charles Tyrwhitt",s:"charles-tyrwhitt",c:"tailoring",p:"h"},
{n:"Cheaney",s:"cheaney",c:"footwear",p:"m"},
{n:"Christian Dior",s:"christian-dior",c:"tailoring",p:"l"},
...
{n:"Closed",s:"closed",c:"shirts-tops",p:"h"},
...
{n:"Cookman",s:"cookman",c:"shirts-tops",p:"l"},
{n:"Corneliani",s:"corneliani",c:"tailoring",p:"m"},
{n:"Corridor",s:"corridor",c:"shirts-tops",p:"m"},
{n:"Corthay",s:"corthay",c:"tailoring",p:"m"},
{n:"COS",s:"cos",c:"shirts-tops",p:"m"},
...
{n:"Danton",s:"danton",c:"shirts-tops",p:"h"},
{n:"De Bonne Facture",s:"de-bonne-facture",c:"shirts-tops",p:"l"},
...
{n:"Document",s:"document",c:"shirts-tops",p:"m"},
{n:"Doppiaa",s:"doppiaa",c:"shirts-tops",p:"m"},
{n:"Drakes",s:"drakes",c:"tailoring",p:"m"},
{n:"Drumohr",s:"drumohr",c:"knitwear",p:"m"},
{n:"Dr\u00f4le de Monsieur",s:"drole-de-monsieur",c:"shirts-tops",p:"m"},
{n:"Duckworth",s:"duckworth",c:"knitwear",p:"h"},
{n:"E. Marinella",s:"e-marinella",c:"tailoring",p:"m"},
{n:"East Harbour Surplus",s:"east-harbour-surplus",c:"shirts-tops",p:"l"},
{n:"Eastlogue",s:"eastlogue",c:"shirts-tops",p:"m"},
{n:"eckhauslatta",s:"eckhauslatta",c:"shirts-tops",p:"l"},
{n:"Ede & Ravenscroft",s:"ede-and-ravenscroft",c:"tailoring",p:"l"},
{n:"Edward Green",s:"edward-green",c:"footwear",p:"h"},
{n:"Edwin",s:"edwin",c:"denim",p:"m"},
{n:"Eleventy",s:"eleventy",c:"tailoring",p:"h"},
{n:"Emma Willis",s:"emma-willis",c:"tailoring",p:"l"},
{n:"Engineered Garments",s:"engineered-garments",c:"shirts-tops",p:"m"},
{n:"Enzo Bonafe",s:"enzo-bonafe",c:"footwear",p:"h"},
{n:"Epaulet",s:"epaulet",c:"shirts-tops",p:"m"},
{n:"Eton Shirts",s:"eton-shirts",c:"tailoring",p:"h"},
{n:"Evan Kinori",s:"evan-kinori",c:"shirts-tops",p:"m"},
{n:"Everlane",s:"everlane",c:"shirts-tops",p:"m"},
{n:"Faherty Brand",s:"faherty-brand",c:"shirts-tops",p:"h"},
{n:"Falconeri",s:"falconeri",c:"knitwear",p:"m"},
{n:"Far Afield",s:"far-afield",c:"shirts-tops",p:"l"},
{n:"Fedeli",s:"fedeli",c:"knitwear",p:"m"},
{n:"Feit",s:"feit",c:"footwear",p:"m"},
{n:"Filson",s:"filson",c:"outerwear",p:"h"},
{n:"Finamore",s:"finamore",c:"tailoring",p:"h"},
...
{n:"Folk",s:"folk",c:"shirts-tops",p:"m"},
{n:"For\u00e9t",s:"foret",c:"shirts-tops",p:"m"},
{n:"Foster And Son",s:"foster-and-son",c:"footwear",p:"l"},
{n:"Frank And Oak",s:"frank-and-oak",c:"shirts-tops",p:"h"},
{n:"Frank Leder",s:"frank-leder",c:"shirts-tops",p:"m"},
{n:"Freenote Cloth",s:"freenote-cloth",c:"shirts-tops",p:"m"},
{n:"Frescobol Carioca",s:"frescobol-carioca",c:"shirts-tops",p:"m"},
{n:"FrizmWORKS",s:"frizmworks",c:"shirts-tops",p:"m"},
{n:"Fujito",s:"fujito",c:"shirts-tops",p:"m"},
{n:"Fullcount",s:"fullcount",c:"denim",p:"m"},
{n:"Gaziano & Girling",s:"gaziano-and-girling",c:"tailoring",p:"m"},
...
{n:"Gran Sasso",s:"gran-sasso",c:"shirts-tops",p:"h"},
...
{n:"100 Hands",s:"100-hands",c:"tailoring",p:"l"},
...
{n:"HAVEN",s:"haven",c:"shirts-tops",p:"m"},
{n:"Hawes & Curtis",s:"hawes-and-curtis",c:"tailoring",p:"m"},
{n:"Heimat Textil",s:"heimat-textil",c:"shirts-tops",p:"m"},
...
{n:"Hiro Yanagimachi",s:"hiro-yanagimachi",c:"tailoring",p:"l"},
{n:"Holzweiler",s:"holzweiler",c:"shirts-tops",p:"m"},
{n:"House of Blanks",s:"house-of-blanks",c:"shirts-tops",p:"m"},
{n:"Husbands",s:"husbands",c:"tailoring",p:"m"},
{n:"Imogene + Willie",s:"imogene-willie",c:"shirts-tops",p:"h"},
{n:"Incotex",s:"incotex",c:"tailoring",p:"h"},
{n:"Informale",s:"informale",c:"tailoring",p:"l"},
...
{n:"Jacquemus",s:"jacquemus",c:"shirts-tops",p:"l"},
{n:"James Coward",s:"james-coward",c:"shirts-tops",p:"m"},
{n:"Japan Blue Jeans",s:"japan-blue-jeans",c:"denim",p:"m"},
{n:"Jil Sander",s:"jil-sander",c:"tailoring",p:"l"},
{n:"Jim Green",s:"jim-green",c:"footwear",p:"m"},
{n:"JL-AL",s:"jl-al",c:"shirts-tops",p:"l"},
{n:"John Lobb",s:"john-lobb",c:"tailoring",p:"m"},
...
{n:"Kapital",s:"kapital",c:"shirts-tops",p:"m"},
{n:"Kaptain Sunshine",s:"kaptain-sunshine",c:"shirts-tops",p:"m"},
{n:"Kardo",s:"kardo",c:"shirts-tops",p:"m"},
{n:"Kartik Research",s:"kartik-research",c:"shirts-tops",p:"m"},
{n:"Kent Wang",s:"kent-wang",c:"tailoring",p:"m"},
{n:"KESTIN",s:"kestin",c:"shirts-tops",p:"h"},
{n:"Kiko Kostadinov",s:"kiko-kostadinov",c:"shirts-tops",p:"l"},
{n:"Kith",s:"kith",c:"shirts-tops",p:"h"},
{n:"Kiton",s:"kiton",c:"tailoring",p:"h"},
{n:"Knickerbocker",s:"knickerbocker",c:"shirts-tops",p:"h"},
{n:"Kotn",s:"kotn",c:"shirts-tops",p:"h"},
{n:"L'Estrange London",s:"lestrange-london",c:"shirts-tops",p:"m"},
...
{n:"Labour Union",s:"labour-union",c:"shirts-tops",p:"l"},
{n:"Lady White Co.",s:"lady-white-co",c:"shirts-tops",p:"h"},
{n:"Lardini",s:"lardini",c:"tailoring",p:"m"},
{n:"Lavenham",s:"lavenham",c:"outerwear",p:"m"},
{n:"Le Laboureur",s:"le-laboureur",c:"shirts-tops",p:"h"},
{n:"Lee",s:"lee",c:"shirts-tops",p:"l"},
{n:"Left Field NYC",s:"left-field-nyc",c:"denim",p:"m"},
{n:"Lemaire",s:"lemaire",c:"shirts-tops",p:"m"},
...
{n:"73London",s:"73london",c:"tailoring",p:"l"},
{n:"Loro Piana",s:"loro-piana",c:"shirts-tops",p:"l"},
...
{n:"NoManWalksAlone",s:"nomanwalksalone",c:"tailoring",p:"m"},
...
{n:"Nudie Jeans",s:"nudie-jeans",c:"shirts-tops",p:"m"},
{n:"Oak Street Bootmakers",s:"oak-street-bootmakers",c:"footwear",p:"h"},
{n:"OAS Company",s:"oas-company",c:"shirts-tops",p:"h"},
{n:"Octobre \u00c9ditions",s:"octobre-editions",c:"shirts-tops",p:"m"},
{n:"Officine G\u00e9n\u00e9rale",s:"officine-generale",c:"tailoring",p:"m"},
{n:"Oliver Spencer",s:"oliver-spencer",c:"tailoring",p:"m"},
{n:"Oni Denim",s:"oni-denim",c:"denim",p:"m"},
{n:"Orazio Luciano",s:"orazio-luciano",c:"tailoring",p:"h"},
{n:"Orlebar Brown",s:"orlebar-brown",c:"shirts-tops",p:"m"},
{n:"Orslow",s:"orslow",c:"shirts-tops",p:"h"},
{n:"Our Legacy",s:"our-legacy",c:"shirts-tops",p:"m"},
{n:"Outclass",s:"outclass",c:"shirts-tops",p:"m"},
{n:"Outerknown",s:"outerknown",c:"shirts-tops",p:"m"},
{n:"Outlier",s:"outlier",c:"shirts-tops",p:"h"},
{n:"Outstanding & Co.",s:"outstanding-and-co",c:"shirts-tops",p:"m"},
{n:"Paraboot",s:"paraboot",c:"footwear",p:"h"},
{n:"3.Paradis",s:"3-paradis",c:"shirts-tops",p:"m"},
{n:"Parel Studio",s:"parel-studio",c:"shirts-tops",p:"l"},
{n:"Parkhurst",s:"parkhurst",c:"footwear",p:"m"},
{n:"Patagonia",s:"patagonia",c:"outerwear",p:"h"},
{n:"Paul & Shark",s:"paul-and-shark",c:"shirts-tops",p:"m"},
{n:"Paul Smith",s:"paul-smith",c:"shirts-tops",p:"h"},
{n:"Pendleton",s:"pendleton",c:"outerwear",p:"m"},
{n:"Percival",s:"percival",c:"",p:"m"},
{n:"Peter Millar",s:"peter-millar",c:"shirts-tops",p:"l"},
{n:"Petru & Claymoor",s:"petru-and-claymoor",c:"tailoring",p:"m"},
{n:"Pike Brothers",s:"pike-brothers",c:"denim",p:"m"},
{n:"Pini Parma",s:"pini-parma",c:"tailoring",p:"m"},
{n:"Portuguese Flannel",s:"portuguese-flannel",c:"shirts-tops",p:"h"},
...
{n:"Proper Cloth",s:"proper-cloth",c:"tailoring",p:"h"},
{n:"Province of Canada",s:"province-of-canada",c:"shirts-tops",p:"m"},
{n:"PT01 / PT Torino",s:"pt01-pt-torino",c:"tailoring",p:"h"},
...
{n:"Rodd & Gunn",s:"rodd-and-gunn",c:"shirts-tops",p:"h"},
{n:"Rogue Territory",s:"rogue-territory",c:"shirts-tops",p:"m"},
{n:"Rolling Dub Trio",s:"rolling-dub-trio",c:"footwear",p:"h"},
{n:"Roots",s:"roots",c:"shirts-tops",p:"m"},
{n:"Rota",s:"rota",c:"tailoring",p:"h"},
{n:"RRD",s:"rrd",c:"outerwear",p:"l"},
{n:"RRL (Ralph Lauren)",s:"rrl-ralph-lauren",c:"shirts-tops",p:"h"},
...
{n:"Sage de Cret",s:"sage-de-cret",c:"shirts-tops",p:"m"},
{n:"Sage Nation",s:"sage-nation",c:"shirts-tops",p:"l"},
{n:"Saint Crispin's",s:"saint-crispins",c:"footwear",p:"m"},
{n:"Salvatore Piccolo",s:"salvatore-piccolo",c:"tailoring",p:"m"},
{n:"Saman Amel",s:"saman-amel",c:"tailoring",p:"h"},
{n:"Samuelsohn",s:"samuelsohn",c:"tailoring",p:"h"},
...
{n:"Save Khaki United",s:"save-khaki-united",c:"shirts-tops",p:"h"},
...
{n:"Sease",s:"sease",c:"shirts-tops",p:"l"},
{n:"Septi\u00e8me Largeur",s:"septieme-largeur",c:"footwear",p:"l"},
{n:"Settefili Cashmere",s:"settefili-cashmere",c:"shirts-tops",p:"m"},
...
{n:"Silvano Lattanzi",s:"silvano-lattanzi",c:"tailoring",p:"l"},
{n:"3sixteen",s:"3sixteen",c:"shirts-tops",p:"h"},
{n:"SMR Days",s:"smr-days",c:"shirts-tops",p:"l"},
{n:"Snow Peak",s:"snow-peak",c:"outerwear",p:"m"},
{n:"Solovair",s:"solovair",c:"footwear",p:"h"},
{n:"Son of a Tailor",s:"son-of-a-tailor",c:"shirts-tops",p:"h"},
{n:"Soulland",s:"soulland",c:"shirts-tops",p:"m"},
{n:"Spencer Badu",s:"spencer-badu",c:"shirts-tops",p:"m"},
{n:"Spier & Mackay",s:"spier-and-mackay",c:"tailoring",p:"h"},
{n:"Stan Ray",s:"stan-ray",c:"shirts-tops",p:"h"},
{n:"Standard Types",s:"standard-types",c:"shirts-tops",p:"m"},
{n:"Stefano Bemer",s:"stefano-bemer",c:"tailoring",p:"m"},
{n:"Sterlingwear",s:"sterlingwear",c:"outerwear",p:"h"},
{n:"Stevenson Overall Co.",s:"stevenson-overall-co",c:"shirts-tops",p:"m"},
...
{n:"Studio Nicholson",s:"studio-nicholson",c:"shirts-tops",p:"m"},
{n:"Stutterheim",s:"stutterheim",c:"outerwear",p:"m"},
{n:"Sugar Cane",s:"sugar-cane",c:"shirts-tops",p:"h"},
{n:"Suitsupply",s:"suitsupply",c:"tailoring",p:"h"},
{n:"Sun Surf",s:"sun-surf",c:"shirts-tops",p:"m"},
{n:"Sunflower",s:"sunflower",c:"shirts-tops",p:"m"},
{n:"Sunspel",s:"sunspel",c:"shirts-tops",p:"h"},
{n:"S\u00e9fr",s:"sefr",c:"shirts-tops",p:"h"},
{n:"Tanuki",s:"tanuki",c:"denim",p:"m"},
{n:"Taylor Stitch",s:"taylor-stitch",c:"shirts-tops",p:"h"},
...
{n:"The Anthology",s:"the-anthology",c:"tailoring",p:"l"},
{n:"The Armoury",s:"the-armoury",c:"tailoring",p:"h"},
{n:"The Elder Statesman",s:"the-elder-statesman",c:"knitwear",p:"m"},
{n:"The Flat Head",s:"the-flat-head",c:"shirts-tops",p:"m"},
{n:"The Gigi",s:"the-gigi",c:"accessories",p:"l"},
{n:"The Iron Snail",s:"the-iron-snail",c:"shirts-tops",p:"h"},
...
{n:"Thom Browne",s:"thom-browne",c:"tailoring",p:"m"},
...
{n:"Undercoverism",s:"undercoverism",c:"shirts-tops",p:"l"},
{n:"Uniform Bridge",s:"uniform-bridge",c:"shirts-tops",p:"m"},
{n:"Uniqlo",s:"uniqlo",c:"shirts-tops",p:"h"},
{n:"Universal Works",s:"universal-works",c:"shirts-tops",p:"m"},
{n:"Valstar",s:"valstar",c:"shirts-tops",p:"h"},
{n:"Vass",s:"vass",c:"footwear",p:"h"},
{n:"Vass Shoes",s:"vass-shoes",c:"tailoring",p:"m"},
{n:"Velasca",s:"velasca",c:"footwear",p:"h"},
{n:"Vetra",s:"vetra",c:"shirts-tops",p:"h"},
{n:"Viberg",s:"viberg",c:"footwear",p:"h"},
{n:"Visvim",s:"visvim",c:"shirts-tops",p:"m"},
{n:"Vuori",s:"vuori",c:"",p:"h"},
{n:"Wales Bonner",s:"wales-bonner",c:"tailoring",p:"l"},
...
{n:"Wax London",s:"wax-london",c:"shirts-tops",p:"m"},
...
{n:"Whitesville",s:"whitesville",c:"shirts-tops",p:"h"},
{n:"William Lockie",s:"william-lockie",c:"knitwear",p:"m"},
{n:"Wings+Horns",s:"wings-horns",c:"shirts-tops",p:"m"},
{n:"Wolf vs Goat",s:"wolf-vs-goat",c:"shirts-tops",p:"h"},
{n:"Wonder Looper",s:"wonder-looper",c:"shirts-tops",p:"h"},
{n:"Woolrich",s:"woolrich",c:"outerwear",p:"m"},
{n:"Wrangler",s:"wrangler",c:"shirts-tops",p:"l"},
{n:"WTAPS",s:"wtaps",c:"shirts-tops",p:"m"},
{n:"Wythe",s:"wythe",c:"shirts-tops",p:"h"},
{n:"YMC",s:"ymc",c:"shirts-tops",p:"m"},
{n:"Yuketen",s:"yuketen",c:"footwear",p:"m"},
{n:"Yves Saint Laurent",s:"yves-saint-laurent",c:"shirts-tops",p:"h"},
{n:"Zanone",s:"zanone",c:"shirts-tops",p:"h"},
